...
uint32_t level2 [26][4] = {
      {1, FIRST_BLOCK_CORD_X1 - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y2, GREEN},

      {1, FIRST_BLOCK_CORD_X1 - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + BLOCK_THICC, YELLOW},
      {1, FIRST_BLOCK_CORD_X1 - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + BLOCK_THICC, YELLOW},
      {1, FIRST_BLOCK_CORD_X1 - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + BLOCK_THICC, YELLOW},

      {1, FIRST_BLOCK_CORD_X1 - BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 2*BLOCK_THICC, ORANGE},
      {1, FIRST_BLOCK_CORD_X1 - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 2*BLOCK_THICC, ORANGE},
      {1, FIRST_BLOCK_CORD_X1 - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 2*BLOCK_THICC, ORANGE},
      {1, FIRST_BLOCK_CORD_X1 - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 2*BLOCK_THICC, ORANGE},
      {1, FIRST_BLOCK_CORD_X1 - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 2*BLOCK_THICC, ORANGE},

      {1, FIRST_BLOCK_CORD_X1, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},
      {1, FIRST_BLOCK_CORD_X1 - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 3*BLOCK_THICC, RED},

      {1, FIRST_BLOCK_CORD_X1 - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 4*BLOCK_THICC, PURPLE},
      {1, FIRST_BLOCK_CORD_X1 - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 4*BLOCK_THICC, PURPLE},
      {1, FIRST_BLOCK_CORD_X1 - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 4*BLOCK_THICC, PURPLE},
      {1, FIRST_BLOCK_CORD_X1 - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 4*BLOCK_THICC, PURPLE},
      {1, FIRST_BLOCK_CORD_X1 - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 4*BLOCK_THICC, PURPLE},

      {1, FIRST_BLOCK_CORD_X1 - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 5*BLOCK_THICC, BLUE},
      {1, FIRST_BLOCK_CORD_X1 - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 5*BLOCK_THICC, BLUE},
      {1, FIRST_BLOCK_CORD_X1 - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 5*BLOCK_THICC, BLUE},

      {1, FIRST_BLOCK_CORD_X1 - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y2 + 6*BLOCK_THICC, LIGHTGREY},
