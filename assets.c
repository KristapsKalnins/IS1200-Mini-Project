...
uint32_t level1[36][4] =
    {
        ...
        {1, FIRST_BLOCK_CORD_X - BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},
        {1, FIRST_BLOCK_CORD_X - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},
        {1, FIRST_BLOCK_CORD_X - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},
        {1, FIRST_BLOCK_CORD_X - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},
        {1, FIRST_BLOCK_CORD_X - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},
        {1, FIRST_BLOCK_CORD_X - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},
        {1, FIRST_BLOCK_CORD_X - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y, RED},

        {1, FIRST_BLOCK_CORD_X, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},
        {1, FIRST_BLOCK_CORD_X - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y + BLOCK_THICC, ORANGE},

        {1, FIRST_BLOCK_CORD_X, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},
        {1, FIRST_BLOCK_CORD_X - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 2*BLOCK_THICC, YELLOW},

        {1, FIRST_BLOCK_CORD_X, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},
        {1, FIRST_BLOCK_CORD_X - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 3*BLOCK_THICC, GREEN},

        {1, FIRST_BLOCK_CORD_X, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},
        {1, FIRST_BLOCK_CORD_X - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 4*BLOCK_THICC, BLUE},

        {1, FIRST_BLOCK_CORD_X, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - 2*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - 3*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - 4*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - 5*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - 6*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE},
        {1, FIRST_BLOCK_CORD_X - 7*BLOCK_LEN, FIRST_BLOCK_CORD_Y + 5*BLOCK_THICC, PURPLE}
};